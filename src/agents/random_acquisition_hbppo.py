...
from src.policies.random_acquisition_hbppo import PolicyBuilder
...
class Agent(object):
    ...
    def set_training_status(self, tsk):
        self.tsk_policy.train(tsk)

    def set_update_status(self, tsk):
        self.update_tsk = tsk
...
class Runner(object):
    ...
    def train(self):
        ...
        self.agent.set_training_status(tsk=True)
        ...
        self.agent.set_update_status(tsk=True)
    ...
    def valid(self, rand_tsk):
        ...
        self.agent.set_training_status(tsk=False)
